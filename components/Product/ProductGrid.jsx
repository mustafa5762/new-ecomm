  ...
  return (
    <div className='px-3 lg:px-16'>
        <div className="mt-20">
          ...
          <p className="text-neutral-600 mt-3 text-[15px] leading-relaxed lg:w-2/5">The easiest thing to wear and the most essential layer is a damn good tee shirt. Long or short sleeve tees henleys crew or v-necks the best mens tees for any style.</p>
        </div>
        <div className="mt-10">
